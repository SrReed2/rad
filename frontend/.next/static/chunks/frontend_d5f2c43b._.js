...
function AuthProvider(param) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (username, password)=>{
            ...
            await new Promise({
                "AuthProvider.useCallback[login]": (r)=>setTimeout(r, 400)
...
_s(AuthProvider, "NhYuG9K1DqdVX//99vrSmpbPHbo=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
"[project]/frontend/context/StudentsContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const StudentsContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
...
function StudentsProvider(param) {
    let { children } = param;
    _s();
    const [students, setStudents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(INITIAL_STUDENTS);
    ...
    const addStudent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentsProvider.useCallback[addStudent]": (data)=>{
            setStudents({
                "StudentsProvider.useCallback[addStudent]": (prev)=>{
                    const newId = prev.length > 0 ? Math.max(...prev.map({
                        "StudentsProvider.useCallback[addStudent]": (s)=>s.id
                    }["StudentsProvider.useCallback[addStudent]"])) + 1 : 1;
                    return [
                        ...prev,
                        {
                            id: newId,
            ...
            }["StudentsProvider.useCallback[addStudent]"]);
        }
    }["StudentsProvider.useCallback[addStudent]"], []);
    const updateStudent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentsProvider.useCallback[updateStudent]": (id, data)=>{
            setStudents({
                "StudentsProvider.useCallback[updateStudent]": (prev)=>prev.map({
                        "StudentsProvider.useCallback[updateStudent]": (s)=>s.id === id ? {
                                ...s,
                                ...data
                            } : s
                    }["StudentsProvider.useCallback[updateStudent]"])
            }["StudentsProvider.useCallback[updateStudent]"]);
        }
    }["StudentsProvider.useCallback[updateStudent]"], []);
    const deleteStudent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentsProvider.useCallback[deleteStudent]": (id)=>{
            setStudents({
                "StudentsProvider.useCallback[deleteStudent]": (prev)=>prev.filter({
                        "StudentsProvider.useCallback[deleteStudent]": (s)=>s.id !== id
                    }["StudentsProvider.useCallback[deleteStudent]"])
            }["StudentsProvider.useCallback[deleteStudent]"]);
        }
    }["StudentsProvider.useCallback[deleteStudent]"], []);
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StudentsProvider.useMemo[value]": ()=>({
                students,
                addStudent,
                updateStudent,
                deleteStudent
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StudentsContext.Provider, {
        value: value,
        children: children
    }, void 0, false, {
        fileName: "[project]/frontend/context/StudentsContext.tsx",
        lineNumber: 75,
        columnNumber: 5
    }, this);
}
_s(StudentsProvider, "aez2VyIRPGwuce54aZ1OdTNSUhM=");
_c = StudentsProvider;
function useStudents() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(StudentsContext);
    if (!ctx) throw new Error("useStudents debe usarse dentro de <StudentsProvider>");
    return ctx;
}
_s1(useStudents, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
__turbopack_context__.k.register(_c, "StudentsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/context/SofiaPanelContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const SofiaPanelContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
function SofiaPanelProvider(param) {
    let { children } = param;
    _s();
    ...
    const open = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SofiaPanelProvider.useCallback[open]": ()=>setIsOpen(true)
    }["SofiaPanelProvider.useCallback[open]"], []);
    const close = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SofiaPanelProvider.useCallback[close]": ()=>setIsOpen(false)
    }["SofiaPanelProvider.useCallback[close]"], []);
    const toggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SofiaPanelProvider.useCallback[toggle]": ()=>setIsOpen({
                "SofiaPanelProvider.useCallback[toggle]": (v)=>!v
            }["SofiaPanelProvider.useCallback[toggle]"])
    }["SofiaPanelProvider.useCallback[toggle]"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SofiaPanelContext.Provider, {
        value: {
            isOpen,
            open,
            close,
        ...
        fileName: "[project]/frontend/context/SofiaPanelContext.tsx",
        lineNumber: 22,
        columnNumber: 5
    }, this);
}
_s(SofiaPanelProvider, "bn+/ocUxd9V5AkX4BwMXzS/Wco8=");
_c = SofiaPanelProvider;
function useSofiaPanel() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(SofiaPanelContext);
    if (!ctx) {
        throw new Error("useSofiaPanel debe usarse dentro de <SofiaPanelProvider>");
    }
    return ctx;
}
_s1(useSofiaPanel, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
__turbopack_context__.k.register(_c, "SofiaPanelProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/components/SofiaPanelHost.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SofiaAssistant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/frontend/components/SofiaAssistant.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/frontend/components/SofiaAssistant.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false
});
_c = SofiaAssistant;
function SofiaPanelHost() {
    _s();
    const { isOpen, close } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$context$2f$SofiaPanelContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSofiaPanel"])();
    ...
    const [hasOpened, setHasOpened] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SofiaPanelHost.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                onClick: close,
                "aria-hidden": "true",
                className: "fixed inset-0 z-[70] bg-slate-950/50 transition-opacity duration-300 lg:hidden ".concat(isOpen ? "opacity-100" : "pointer-events-none opacity-0")
            }, void 0, false, {
                fileName: "[project]/frontend/components/SofiaPanelHost.tsx",
                lineNumber: 25,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed right-4 top-4 bottom-4 z-[80] w-[calc(100%-2rem)] max-w-sm transition-all duration-300 ease-out ".concat(isOpen ? "translate-x-0 opacity-100" : "pointer-events-none translate-x-6 opacity-0"),
                children: hasOpened && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SofiaAssistant, {
                    onClose: close
                }, void 0, false, {
                    fileName: "[project]/frontend/components/SofiaPanelHost.tsx",
                    lineNumber: 41,
...
_s(SofiaPanelHost, "sTKvvxdtmrsTPAC69a/fg1OqOZA=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "SofiaPanelHost");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_d5f2c43b._.js.map